...
from utilities.mixins.admins import CustomModelExemptedAdmin
...
admin.site.site_header = getattr(settings, "ADMIN_SITE_HEADER", "Bi Advisory Admin")
admin.site.site_title = getattr(settings, "ADMIN_SITE_TITLE", "Bi Advisory Admin Portal")
admin.site.index_title = getattr(settings, "ADMIN_INDEX_TITLE", "Bienvenue sur Bi Advisory Admin")
